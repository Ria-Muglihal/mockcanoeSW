...
class Element {
 ...
 public:
    virtual ~Element();
    virtual void handleElement(pugi::xml_node xmlParentNode, XmlParser *parser, const char *childName, int isEmptyElement);
    virtual void printElement(int indent);
    const char *getAttributeValue(XmlParser::Att att);  // value or NULL if not present
	const char getAttributeString(XmlParser::Att att, XmlParser::ValueStatus *vs);
...
class ListElement : public Element {
 ...
 public:
    ~ListElement();
    void handleElement(pugi::xml_node xmlParentNode, XmlParser *parser, const char *childName, int isEmptyElement);
