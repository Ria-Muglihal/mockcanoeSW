...
class XmlParser {
 public:
    // Elements
    static const int SIZEOF_ELM = 32;
    ...
    enum Elm {
        ...
        elm_SimpleType, elm_Real, elm_Integer, elm_Boolean, elm_String, elm_Binary,
    ...
    enum Att {
        ...
        att_previous, att_canHandleMultipleSetPerTimeInstant, att_declaredType, att_start, att_mimeType, att_derivative,
 ...
 public:
    ...
    void parseElementAttributes(pugi::xml_node xmlParentNode, Element *element);
    void parseElementAttributes(pugi::xml_node xmlParentNode, Element *element, bool ignoreUnknownAttributes);
    void parseChildElements(pugi::xml_node xmlParentNode, Element *el);
